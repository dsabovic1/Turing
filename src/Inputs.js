...
function AddButton(props) {
  return <Button {...props} text={<AddIcon />} />;
}
...
class ToggleButton extends Component {
  ...
  toggle() {
    ...
    if (currentValueIndex === -1)
      throw new Error("this.props.value does not exist in this.props.values");
    let newValue = this.props.values[
      (currentValueIndex + 1) % this.props.values.length
    ];
  ...
  render() {
    ...
    return <Button fullWidth onClick={this.toggle} text={text} />;
  }
}
