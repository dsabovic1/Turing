    ...
    return (
      ...
      >
          ...
          <ListRow header minWidth={this.props.minWidth}>
            {this.props.header.map((header, index) => {
              return (
                <ListColumn
                  width={
                    this.props.columnWidths && this.props.columnWidths[index]
                  }
                >
                  {header}
                </ListColumn>
        ...
        {this.props.items.map((row, index) => {
          return (
            <ListRow
              primary={this.props.primaryHighlightIndex === index}
            ...
            >
              ...
              {this.props.removeItem !== undefined && (
                <ListColumn>
                  <RemoveButton onClick={(e) => this.props.removeItem(index)} />
                </ListColumn>
              )}
            </ListRow>
          );
        ...
        {(this.props.addNew !== undefined ||
          ...
          <ListRow utility>
            {this.props.addNew !== undefined && (
              <ListColumn>
                <AddButton onClick={this.props.addNew} />
              </ListColumn>
            )}
            {this.props.removeLast !== undefined && (
              <ListColumn>
                <RemoveButton onClick={this.props.removeLast} />
              </ListColumn>
            )}
          </ListRow>
        )}
